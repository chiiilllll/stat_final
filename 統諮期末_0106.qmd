...
其中BMI.Category, Occupation, Stress.Level 和 Quality.of.Sleep 等變數都與 Sleep.Disorder 具有高度相關性

Blood.Pressure 在 SHAP 圖中顯示為重要的預測變數

睡眠時長和睡眠品質的關係、壓力等級和睡眠時長的關係、以及身體活動水平與 BMI 和睡眠障礙的關係，也支持這些變數作為預測變數的合理性。
