...
```{r}
ggplot(data, aes(x = Stress.Level, y = Physical.Activity.Level, color = Sleep.Disorder)) +
...
logistic_model_steps <- glm(Sleep.Disorder ~ Blood.Pressure + BMI.Category   ,  data = train_data, family = binomial())
...
# 手選變數模型
model_self <- train(Sleep.Disorder ~  BMI.Category  + Blood.Pressure +Physical.Activity.Level+ Stress.Level  ,
                    data = data, method = "glm", family = "binomial", 
                    trControl = train_control)
